        ...
        if len(nombres)==0:
            ...
            #Eliminar ciclista
                    ...
                    if pos==-1:
                        ...
                        print('No se encontro al ciclista '+nomb+',','tal vez quisiste decir:\n')
                        print(nombres[x],f'{simi[x]/100:.2%}','de coincidencia')
...
#Modificar
        ...
        if len(nombres)==0:
            ...
            while True:
                ...
                print('4) Ordenar por orden alfabético')
                print('5) Regresar al menú principal\n')
                print('Escoja una opción')
                opm=innum()
